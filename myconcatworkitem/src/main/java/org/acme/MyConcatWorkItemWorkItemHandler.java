...
@Wid(widfile = "MyConcatWorkItemDefinitions.wid", name = "MyConcatWorkItemDefinitions",
        displayName = "MyConcatWorkItemDefinitions",
        defaultHandler = "mvel: new org.acme.MyConcatWorkItemWorkItemHandler()",
        documentation = "myconcatworkitem/index.html",
        category = "myconcatworkitem",
        icon = "MyConcatWorkItemDefinitions.png",
        parameters = {
...
public class MyConcatWorkItemWorkItemHandler extends AbstractLogOrThrowWorkItemHandler {
    private String sampleParam;
    private String sampleParamTwo;

    public MyConcatWorkItemWorkItemHandler(String SampleParam, String SampleParamTwo) {
